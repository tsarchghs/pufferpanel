...
main ()
{
  ...
  gpg_key_url="https://packagecloud.io/pufferpanel/gpgkey"
  apt_config_url="https://packagecloud.io/install/repositories/pufferpanel/config_file.list?os=${os}&dist=${dist}&source=script"
